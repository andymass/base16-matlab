% base16-solarized-light: sets MATLAB GUI colors 
%   base16-matlab (https://github.com/andymass/base16-matlab)
%   base16 by Chris Kempson (http://chriskempson.com)
%   scheme Solarized Light by Ethan Schoonover (http://ethanschoonover.com/solarized)
...
gui0E = '0x6c71c4';
gui0F = '0xd33682';
hlsect = mix( [ 253, 246, 227 ], [238 232, 213 ], 75 ) / 255;
