% base16-gruvbox-dark-soft: sets MATLAB GUI colors 
%   base16-matlab (https://github.com/andymass/base16-matlab)
%   base16 by Chris Kempson (http://chriskempson.com)
%   scheme Gruvbox dark, soft by Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)
...
gui0E = '0xd3869b';
gui0F = '0xd65d0e';
hlsect = mix( [ 50, 48, 47 ], [60 56, 54 ], 75 ) / 255;
