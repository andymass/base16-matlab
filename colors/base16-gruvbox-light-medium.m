% base16-gruvbox-light-medium: sets MATLAB GUI colors 
%   base16-matlab (https://github.com/andymass/base16-matlab)
%   base16 by Chris Kempson (http://chriskempson.com)
%   scheme Gruvbox light, medium by Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)
...
gui0E = '0x8f3f71';
gui0F = '0xd65d0e';
hlsect = mix( [ 251, 241, 199 ], [235 219, 178 ], 75 ) / 255;
